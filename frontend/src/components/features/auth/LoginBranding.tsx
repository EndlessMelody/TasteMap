  ...
  return (
    <div
      style={{
        ...
        minHeight: "100vh",
        background:
          "linear-gradient(145deg, #0A0F1E 0%, #0D1A3A 40%, #0A0A1A 100%)",
        position: "relative",
        overflow: "hidden",
        display: "flex",
    ...
    >
      ...
      <motion.div
        ...
        style={{
          ...
          borderRadius: "50%",
          background:
            "radial-gradient(circle, rgba(0,100,255,0.18) 0%, transparent 65%)",
          pointerEvents: "none",
        }}
      />
      <motion.div
        ...
        style={{
          ...
          borderRadius: "50%",
          background:
            "radial-gradient(circle, rgba(130,60,220,0.14) 0%, transparent 65%)",
          pointerEvents: "none",
        }}
      />
      ...
      >
        <div
          style={{
            ...
            boxShadow: "0 0 20px rgba(0,100,255,0.35)",
          }}
        >
